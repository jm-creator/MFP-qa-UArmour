...
public class LocalDriverManager implements IDriver {
    ...
    public WebDriver createInstance(String browser) {
        ...
        io.github.bonigarcia.wdm.config.DriverManagerType driverManagerType = io.github.bonigarcia.wdm.config.DriverManagerType.valueOf(browser.toUpperCase());
        ...
        switch (driverManagerType) {
            ...
            case EDGE:
                driverInstance =
                        isHeadless ? new EdgeDriver(new EdgeOptions()) : new EdgeDriver();
                break;
            case IEXPLORER:
                if (isHeadless) headlessNotSupportedForThisBrowser(driverManagerType);
